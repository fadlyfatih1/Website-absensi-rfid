...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 22, 2025 at 02:06 AM
...
--
CREATE DATABASE IF NOT EXISTS `absensi_rfid` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `absensi_rfid`;
...
--
ALTER TABLE `absensi`
  ADD CONSTRAINT `absensi_ibfk_1` FOREIGN KEY (`id_kartu`) REFERENCES `kartu_rfid` (`id`);
--
-- Database: `phpmyadmin`
--
...
('root', '[{\"db\":\"absensi_system\",\"table\":\"users\"},{\"db\":\"absensi_system\",\"table\":\"attendance\"},{\"db\":\"absensi_system\",\"table\":\"rfid_cards\"},{\"db\":\"absensi_rfid\",\"table\":\"absensi\"},{\"db\":\"absensi_rfid\",\"table\":\"mahasiswa\"}]');
...
('root', '2025-05-02 12:43:46', '{\"Console\\/Mode\":\"collapse\"}');
